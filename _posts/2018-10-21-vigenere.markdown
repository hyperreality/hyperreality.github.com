...
Last week I competed in the [European Cyber Security Challenge](https://www.europeancybersecuritychallenge.eu), vice-captaining the UK team. I spent the first morning working on a "modified Vigenère" challenge. This post describes a highly effective method of cryptanalysing Vigenère ciphers and how it was adapted to solve the challenge.
