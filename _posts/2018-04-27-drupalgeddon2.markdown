...
Which, prettified, is simply submitting the following render array to the 'reset password' form:
...
Perhaps intelligence agencies or other groups were aware of it, but&mdash;speculation aside&mdash;even after [the patch](https://github.com/drupal/drupal/commit/19b69fe8af55d8fac34a50563a238911b75f08f7) was publicly released, it still took hard-working security researchers two weeks to come up with an exploit.
...
It's not just Drupal that I'm implicating. The majority of use-cases for CMSs would be better served by static site generators. Static sites are immune by default to the kinds of crazy vulnerabilities lurking in CMSs. They also come with a host of [other benefits](https://www.netlify.com/blog/2016/05/18/9-reasons-your-site-should-be-static/). Previously, the main disadvantage of static site generators (and in favour of CMSs) was that they were hard to use for non-technical people, but tooling has improved significantly in recent years.

I don't know if there will be a Drupalgeddon3, but I'm certain that as long as most of the web runs on ancient, monolithic PHP platforms, huge bugs like this will continue to be found, and will continue to cause great alarm. Or great amusement, if you 'that kind' of person in cybersecurity.
