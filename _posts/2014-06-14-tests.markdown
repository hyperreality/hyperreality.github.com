...
I eventually discovered that the MBTI possesses a poor reputation in academic psychology due to its lack of empirical validity. People score different results from month to month; the type descriptions are mostly flattering [Forer statements](https://en.wikipedia.org/wiki/Forer_effect); and we type ourselves against culturally normative concepts; for instance, an introvert in the US is often an extrovert in the UK. Worst of all, the test is a crucial agent in the continuing life of several long-discredited Victorian notions, such as the thinking / feeling axis.

In fact, it is the simple, two-dimensional nature of the Myers-Briggs test that has led to the its popular dominance over more nuanced alternatives like the [Big Five](https://en.wikipedia.org/wiki/Big_Five_personality_traits#Critique). The MBTI is easy to grasp right down to the individual syllables: the hard consonants of 'NTJ' seem designed to reflect the decisiveness of the corresponding personality type. In truth, one's relationship to society is far more multifaceted than a handful of letters can ever begin to indicate.
